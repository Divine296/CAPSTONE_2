...
const recommendedData = [
  { id: "1", image: require("../../assets/reco1.jpg"), title: "Spicy Chicken", price: 150, rating: 4.5, reviews: 12 },
  { id: "2", image: require("../../assets/reco2.jpg"), title: "Cheesy Burger", price: 120, rating: 4.2, reviews: 8 },
  { id: "3", image: require("../../assets/reco3.jpg"), title: "Fresh Salad", price: 100, rating: 4.8, reviews: 15 },
];
...
const styles = StyleSheet.create({
  ...
  overlayText: { position: "absolute", bottom: 12, left: 12, color: "#fff", fontFamily: "Roboto_700Bold", fontSize: 18 },
  ...
  popupImage: { width: "100%", height: width * 0.5, borderRadius: 16, marginBottom: 16 },
