    ...
    <AuthLayout>
      ...
      <Modal visible={cameraOpen} animationType="slide" onRequestClose={closeCamera} presentationStyle="fullScreen">
        <View style={{ flex: 1, backgroundColor: "black" }}>
          {isFocused ? <CameraView style={{ flex: 1 }} facing="front" /> : <View style={{ flex: 1 }} />}
          <TouchableOpacity onPress={closeCamera} style={{ position: "absolute", top: insets.top + 12, right: 12 }}>
